...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-screen px-4 py-4 md:flex md:flex-col bg-gradient-to-b from-[#171417] to-[#0E0317] w-[250px] flex-shrink-0 top-0",
          className
        )}
        animate={{
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-neutral-700 text-lg group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </Link>
