        ...
        <div className="w-full" {...getRootProps()}>
            ...
            >
                ...
                <div className="flex flex-col items-center justify-center">
                    <p className="relative z-20 font-sans font-bold text-[#e2e2e2] text-base">
                        Upload Cover
                    </p>
                        ...
                        {files.length > 0 &&
                            files.map((file, idx) => (
                                <motion.div
                                    ...
                                    className={cn(
                                        "relative overflow-hidden z-40 bg-[#e2e2e2] flex flex-col items-start justify-start md:h-24 p-4 mt-4 w-full mx-auto rounded-md",
                                        "shadow-sm"
                                    )}
                                >
                                    <div className="flex justify-between w-full items-center gap-4">
                                        <motion.p
                                            ...
                                            animate={{ opacity: 1 }}
                                            layout
                                            className="text-base text-neutral-700 0 truncate max-w-xs"
                                        >
                                            {file.name}
                                        </motion.p>
                                        <motion.p
